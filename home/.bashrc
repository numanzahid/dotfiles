...
# Active prompt is ~/.config/dotfiles/prompt.sh (optimized, custom, or starship).
# Devbox/server default: prompt-optimized.sh. Desktop: prompt-starship.sh.
# Switch: ln -sfn ~/.dotfiles/home/.config/dotfiles/prompt-optimized.sh ~/.config/dotfiles/prompt.sh
#     or: ln -sfn ~/.dotfiles/home/.config/dotfiles/prompt-custom.sh ~/.config/dotfiles/prompt.sh
